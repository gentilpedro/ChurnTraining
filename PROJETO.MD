...
[http://localhost:8080](http://localhost:8080) com o serviço `site`, ou simplesmente abrir com duplo clique —
...
- **[http://localhost:8080](http://localhost:8080)** — o painel completo, para operar.
- **[http://localhost:8080/resumo.html](http://localhost:8080/resumo.html)** — o resumo, para apresentar.
...
fica baixável em [http://localhost:8080/clientes_em_risco.csv](http://localhost:8080/clientes_em_risco.csv).
